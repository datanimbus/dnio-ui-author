...
@Component({
  selector: 'odp-group-logs',
  templateUrl: './group-logs.component.html',
  styleUrls: ['./group-logs.component.scss']
})
export class GroupLogsComponent implements OnInit, OnDestroy {
